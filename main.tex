...
Among the two models evaluated in this report, the Artificial Neural Network consistently outperformed the Decision Tree across all metrics, achieving 87.42\% overall accuracy and a Kappa coefficient of 0.8322 compared to 78.17\% and 0.7089 for the optimized Decision Tree. Both models showed the highest classification performance for the \textit{Vegetacion} and \textit{Zona\_urbana} classes, while \textit{Suelo\_desnudo} and \textit{Cultivos} proved more challenging to distinguish spectrally.

The complete comparative analysis, including SVM, KNN, and Naive Bayes results, will be integrated once all team contributions are compiled.
