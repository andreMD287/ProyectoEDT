...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{mapa_fase3.png}
\caption{Predicted land-cover map of the Armero study area, obtained by applying the optimized ANN model to the full Sentinel-2 scene. Green: vegetation; light green: croplands; orange: bare soil; blue: urban areas.}
