...
All models were evaluated using standard classification metrics: Overall Accuracy, Kappa Coefficient, Precision, Recall, and F1-Score. Additionally, Hyperparameter Optimization (HPO) was performed on each model using 5-fold cross-validation to maximize predictive performance.
