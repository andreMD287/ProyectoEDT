...
ruta_r10 <- "C:/Users/valeh/Downloads/S2A_MSIL2A_20240815T152651_N0511_R025_T18NWL_20240815T223702.SAFE/GRANULE/L2A_T18NWL_A047784_20240815T152653/IMG_DATA/R10m/"
ruta_r20 <- "C:/Users/valeh/Downloads/S2A_MSIL2A_20240815T152651_N0511_R025_T18NWL_20240815T223702.SAFE/GRANULE/L2A_T18NWL_A047784_20240815T152653/IMG_DATA/R20m/"
salida   <- "C:/Users/valeh/Downloads/proyecto-emergentes"
# ────────────────────────────────────────────────────────────

# 10m bands (native resolution)
...
# Resample 20m bands to 10m (bilinear interpolation)
ref <- B2
...
# Stack all 10 bands and assign names
...
message("Dimensions: ", nrow(stack), " rows x ", ncol(stack), " cols")
message("Bands: ", nlyr(stack))
